...
export enum Permission { GRANTED, DENIED, INHERITED }





export type AccessGuard = (req: Request) => Permission | Promise<Permission>;
...
function makeQualifierChain(deriveState: (predicate: AccessPredicate) => ChainState) {
    ...
    type QualifierChain = (predicate: AccessPredicate) => AccessGuard & {
        and: QualifierChain;
        or: QualifierChain;
        else: {
