...
import RouteSegment = require('../src/route-segment');
var parser = require('../src/route-pattern-dsl');
var parse: (text: string) => any[] = parser.parse;



describe('A RouteSegment instance', () => {
     it('works', () => {


        var s0 = new RouteSegment(parse('/foo*bR{id}')[0][0]);
