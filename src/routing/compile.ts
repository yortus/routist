...
export default function compile(routeTable: {[pattern: string]: Function}) {
    ...
    let routes = makeAllRouters(routeTable); // TODO: fix terminology: 'handler' is taken...
...
// TODO: ...
function makeAllRouters(routeTable: {[pattern: string]: Function}): Map<Pattern, Handler> {
