...
class RouteFamily {
    ...
    constructor(base, specialisations) {
        this.base = base;
     ...
     */
    getHandlerForRequest(method, pathname) {
 ...
 */
function generateHandlerForRequest(family, method, pathname) {
...
module.exports = RouteFamily;
//# sourceMappingURL=route-family-0.js.map