module.exports = (function() {
  ...
  function peg$parse(input) {
    ...
    function peg$parsePattern() {
      ...
      s1 = peg$currPos;
      peg$silentFails++;
      if (input.charCodeAt(peg$currPos) === 8709) {
        s2 = peg$c0;
        peg$currPos++;
      } else {
        s2 = peg$FAILED;
